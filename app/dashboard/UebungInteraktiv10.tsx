...
const questions: Question[] = [
  {
    id: 1,
    segments: [
      { type: 'text', val: '1. Wir wohnen in einem schönen Altbau im dritten Stockwerk. ' },
      { type: 'input', id: 'q1_1', ans: 'Trotzdem', width: 'w-24' },
      { type: 'text', val: ' haben wir keinen Balkon. In der Wohnung nebenan lebt Frau Netzer. Am Wochenende waren wir weg, ' },
      { type: 'input', id: 'q1_2', ans: 'deshalb', width: 'w-24' },
      { type: 'text', val: ' ist Frau Netzer in unsere Wohnung gegangen und wollte unsere dicke Katze Lenny füttern.' }
    ]
  },
  {
    id: 2,
    segments: [
      { type: 'text', val: '2. ' },
      { type: 'input', id: 'q2_1', ans: 'Als', width: 'w-20' },
      { type: 'text', val: ' sie die Wohnungstür aufgemacht hat, ist Lenny blitzschnell weggelaufen. Immer ' },
      { type: 'input', id: 'q2_2', ans: 'wenn', width: 'w-24' },
      { type: 'text', val: ' Lenny eine Tür sieht, möchte er nach draußen.' }
    ]
  },
  {
    id: 3,
    segments: [
      { type: 'text', val: '3. Er lief ' },
      { type: 'input', id: 'q3_1', ans: 'auf', width: 'w-20' },
      { type: 'text', val: ' die Straße. Frau Netzer war ' },
      { type: 'input', id: 'q3_2', ans: 'besorgt', width: 'w-24' },
      { type: 'text', val: ', aber ' },
      { type: 'input', id: 'q3_3', ans: 'später', width: 'w-20' },
      { type: 'text', val: ' kam Lenny von ganz alleine zurück.' }
    ]
  },
  {
    id: 4,
    segments: [
      { type: 'text', val: '4. Meine Nachbarn spielen oft laute Musik. ' },
      { type: 'input', id: 'q4_1', ans: 'Deshalb', width: 'w-24' },
      { type: 'text', val: ' habe ich mich bei ihnen ' },
      { type: 'input', id: 'q4_2', ans: 'beschwert', width: 'w-28' },
      { type: 'text', val: '.' }
    ]
  },
  {
    id: 5,
    segments: [
      { type: 'text', val: '5. Die Wohnung liegt weit außerhalb vom Zentrum. ' },
      { type: 'input', id: 'q5_1', ans: 'Trotzdem', width: 'w-24' },
      { type: 'text', val: ' fühle ich mich hier sehr ' },
      { type: 'input', id: 'q5_2', ans: 'wohl', width: 'w-20' },
      { type: 'text', val: '.' }
    ]
  }
];

export default function UebungInteraktiv10() {
  ...
  const handleEvaluateSchreiben = async () => {
    ...
    try {
      const res = await fetch('/api/evaluateSchreiben', {
        ...
        body: JSON.stringify({ 
          text: schreibenText,
          topic: "Schreibe eine kurze Geschichte über ein Haustier oder einen Umzug. Verwende die Wörter 'als', 'wenn', 'deshalb' und 'trotzdem'."
        })
      });
        ...
        <div className="clay-card p-8 bg-sky-50 border-sky-200 border-b-8">
          ...
          <div className="bg-white p-5 rounded-xl border-2 border-sky-100 mb-6">
            ...
            <div className="text-slate-600 italic border-l-4 border-sky-400 pl-3">
              Schreibe eine kurze Geschichte über ein Haustier oder einen Umzug (30–40 Wörter):<br/><br/>
              1. Was ist passiert?<br/>
              2. Wie hast du dich gefühlt?<br/>
              3. Verwende die Wörter "als", "wenn", "deshalb" und "trotzdem".
            </div>
          </div>
          ...
          <textarea
            ...
            placeholder="Als ich ein Kind war, hatten wir einen kleinen Hund..."
          ...
          >
            {isEvaluating ? '🤖 AI sedang mengoreksi...' : '✨ Evaluasi mit AI'}
          </button>
