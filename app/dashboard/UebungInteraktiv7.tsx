...
export function UebungInteraktiv7() {
  ...
  const evaluateText = async () => {
    ...
    try {
      const response = await fetch('/api/evaluateSchreiben', {
        ...
        body: JSON.stringify({ 
          text: inputText, 
          topic: "Schreiben Sie einen kurzen Text über Ihren Weg zur Arbeit / zur Schule (Pendeln). (Welche Verkehrsmittel nutzen Sie? Wie lange dauert das? Gibt es oft Probleme wie Stau oder Verspätung?)" 
        })
      });
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 mt-2 text-lg">Schreiben Sie einen kurzen Text über Ihren Arbeitsweg (Weg zur Schule/Arbeit).</p>
      </div>
      ...
      <div className="clay-card p-8 bg-white border-4 border-amber-200 shadow-xl relative overflow-hidden">
        ...
        <h3 className="text-2xl font-black text-amber-900 mb-2 relative z-10">Aufgabe: Unterwegs</h3>
        <p className="text-slate-700 mb-6 text-lg relative z-10">Schreiben Sie einen kurzen Text über Ihren täglichen Weg zur Arbeit oder zur Schule (mindestens 6 Sätze).</p>
        
        <div className="bg-slate-50 p-6 rounded-2xl border-2 border-slate-300 mb-6 shadow-inner relative z-10">
          <p className="text-sm font-bold text-amber-600 uppercase tracking-widest mb-3">Beantworten Sie diese Fragen:</p>
          <ul className="list-disc pl-5 space-y-1 text-slate-700 font-medium leading-relaxed">
            <li>Welche Verkehrsmittel nutzen Sie normalerweise? (z.B. Bus, Fahrrad, Auto)</li>
            <li>Wie lange dauert Ihr Weg zur Arbeit oder zur Schule?</li>
            <li>Haben Sie oft Probleme auf dem Weg? (z.B. Stau, Zug hat Verspätung, kein Parkplatz)</li>
            <li>Was machen Sie während der Fahrt? (z.B. Musik hören, lesen, schlafen)</li>
          </ul>
        </div>
        ...
        <textarea 
          ...
          placeholder="Ich fahre jeden Tag mit..."
          spellCheck="false"
        />
        ...
        <div className="mt-6 flex justify-end relative z-10">
          ...
          >
            {isEvaluating ? 'Mengevaluasi...' : 'Cek mit AI ✨'}
          </button>
        </div>
