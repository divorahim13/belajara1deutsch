...
export function UebungInteraktiv8() {
  ...
  const evaluateText = async () => {
    ...
    try {
      const response = await fetch('/api/evaluateSchreiben', {
        ...
        body: JSON.stringify({ 
          text: inputText, 
          topic: "Schreiben Sie einen kurzen Text über ein soziales Projekt, das Sie gut finden. (Was ist das Projekt? Wer macht mit? Warum ist es wichtig?)" 
        })
      });
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 mt-2 text-lg">Schreiben Sie einen kurzen Text über ein soziales Projekt.</p>
      </div>
      ...
      <div className="clay-card p-8 bg-white border-4 border-amber-200 shadow-xl relative overflow-hidden">
        ...
        <h3 className="text-2xl font-black text-amber-900 mb-2 relative z-10">Aufgabe: Ein soziales Projekt</h3>
        <p className="text-slate-700 mb-6 text-lg relative z-10">Schreiben Sie einen kurzen Text über ein soziales Projekt, das Sie gut finden (mindestens 6 Sätze).</p>
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border-2 border-slate-300 mb-6 shadow-inner relative z-10">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-700 font-medium leading-relaxed">
            <li>Was ist das Projekt? (Wie heißt es? Was macht man da?)</li>
            <li>Wer macht bei dem Projekt mit? (Freiwillige, Experten, Jugendliche?)</li>
            <li>Wem hilft das Projekt? (Kindern, alten Menschen, der Umwelt?)</li>
            <li>Warum finden Sie das Projekt wichtig oder gut?</li>
          </ul>
        </div>
        ...
        <textarea 
          ...
          placeholder="Ich finde das Projekt ... sehr gut. Es ist ein Projekt für..."
          spellCheck="false"
        />
