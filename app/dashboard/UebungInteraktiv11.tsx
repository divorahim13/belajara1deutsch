...
const questions: Question[] = [
  {
    id: 1,
    segments: [
      { type: 'text', val: '1. Linda freut sich ' },
      { type: 'input', id: 'q1_1', ans: 'auf', width: 'w-20' },
      { type: 'text', val: ' den Ausflug. Thilo hat sich ' },
      { type: 'input', id: 'q1_2', ans: 'um', width: 'w-20' },
      { type: 'text', val: ' die Tickets gekümmert.' }
    ]
  },
  {
    id: 2,
    segments: [
      { type: 'text', val: '2. ' },
      { type: 'input', id: 'q2_1', ans: 'Worüber', width: 'w-24' },
      { type: 'text', val: ' ärgert sich Milan? Er ärgert sich ' },
      { type: 'input', id: 'q2_2', ans: 'über', width: 'w-20' },
      { type: 'text', val: ' die Prüfung.' }
    ]
  },
  {
    id: 3,
    segments: [
      ...
      { type: 'text', val: ' wen wartet Mereth? Sie wartet auf Milan.' }
    ]
  },
  {
    id: 4,
    segments: [
      { type: 'text', val: '4. Ich ' },
      { type: 'input', id: 'q4_1', ans: 'hätte', width: 'w-20' },
      { type: 'text', val: ' gern mehr Zeit. Ich ' },
      { type: 'input', id: 'q4_2', ans: 'wäre', width: 'w-20' },
      { type: 'text', val: ' gern öfter zu Hause.' }
    ]
  },
  {
    id: 5,
    segments: [
      { type: 'text', val: '5. An deiner Stelle ' },
      { type: 'input', id: 'q5_1', ans: 'würde', width: 'w-20' },
      { type: 'text', val: ' ich mit der U-Bahn fahren.' }
    ]
  }
];

export default function UebungInteraktiv11() {
  ...
  const handleEvaluateSchreiben = async () => {
    ...
    try {
      const res = await fetch('/api/evaluateSchreiben', {
        ...
        body: JSON.stringify({ 
          text: schreibenText,
          topic: "Schreiben Sie 3 Wünsche mit Konjunktiv II (hätte/wäre/würde) und 2 Ratschläge an einen Freund, der viel Stress hat."
        })
      });
      ...
      {activeTab === 1 && (
        <div className="clay-card p-8 bg-emerald-50 border-emerald-200 border-b-8">
          <div className="bg-white p-5 rounded-xl border-2 border-sky-100 mb-6">
            ...
            <p className="text-slate-700 font-medium">Ergänzen Sie die Sätze mit dem passenden Konjunktiv II, der Präposition oder dem W-Fragewort.</p>
          </div>
        ...
        <div className="clay-card p-8 bg-sky-50 border-sky-200 border-b-8">
          <div className="bg-white p-5 rounded-xl border-2 border-sky-100 mb-6">
            ...
            <p className="text-slate-700 font-medium">
              Schreiben Sie 3 Wünsche mit Konjunktiv II (hätte/wäre/würde) und 2 Ratschläge an einen Freund, der viel Stress hat.
            </p>
            <div className="mt-4 p-4 bg-sky-50 rounded-xl border border-sky-100">
              <p className="text-sm font-bold text-sky-800">Tips:</p>
              <ul className="list-disc list-inside text-sm text-sky-700 mt-2 space-y-1">
                <li>Verwende <em>Ich hätte gern...</em> oder <em>Ich wäre gern...</em></li>
                <li>Verwende <em>An deiner Stelle würde ich...</em> oder <em>Du solltest...</em></li>
              </ul>
            </div>
          </div>
