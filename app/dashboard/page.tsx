                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <h3 className="text-2xl font-black text-orange-950">Partizip II Lampau</h3>
                      <p className="text-indigo-900 mt-2 text-sm font-bold leading-relaxed">Tebak bentuk Partizip II dan tentukan Hilfsverb (haben/sein).</p>
